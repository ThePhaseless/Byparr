...
| `CAPTCHA_RETRIES`    | 5                      | Number of times to retry solving a CAPTCHA challenge before giving up. This helps in cases where CAPTCHA challenges fail intermittently and can be retried successfully.                                                                                                                       |
